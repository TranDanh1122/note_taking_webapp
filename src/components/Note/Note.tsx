...
export default function Note(): React.JSX.Element {
    ...
    return (
        <>
            ...
            <div className="w-[50%] mb:w-full tb:w-full mb:h-full tb:h-full mb:block tb:block mb:py-[15%] tb:py-[15%] px-6 py-5 flex flex-col gap-5">
            <MobileAction note={note} key={v4()} />
                ...
                <textarea onChange={(e) => handleChange(e, "content")} value={note?.content ?? ""}
                    ...
                    className={clsx("h5 h-full w-full tb:min-h-[50vh] mb:min-h-[50vh] outline-none text-wrap whitespace-pre-line pb-2  ", {
                ...
                <div className="flex items-center gap-4 mb:hidden tb:hidden">
